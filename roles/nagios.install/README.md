...
==============
Asomiddin: 
Add hosts in hosts (inventory) file
Change nagios adminuser password in install/group_vars/all.yml
Run playbook : time ansible-playbook -i hosts /install/nagios.yml
